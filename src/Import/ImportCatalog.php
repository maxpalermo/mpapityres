...
class ImportCatalog
{
    ...
    {
        \Configuration::updateValue(Constants::MPAPITYRES_CRON_IMPORT_OFFSET, $this->offset);
        \Configuration::updateValue(Constants::MPAPITYRES_CRON_IMPORT_UPDATED, $this->updated);
        \Configuration::updateValue(Constants::MPAPITYRES_CRON_IMPORT_STATUS, $this->status);
        \Configuration::updateValue(Constants::MPAPITYRES_CRON_IMPORT_UPDATED_DATE, $this->updated_date);
    }

    protected function readStatus()
    {
        $this->offset = (int) \Configuration::get(Constants::MPAPITYRES_CRON_IMPORT_OFFSET) ?: 0;
        $this->updated = (int) \Configuration::get(Constants::MPAPITYRES_CRON_IMPORT_UPDATED) ?: 0;
        $this->status = \Configuration::get(Constants::MPAPITYRES_CRON_IMPORT_STATUS) ?: "FETCHING";
        $this->updated_date = \Configuration::get(Constants::MPAPITYRES_CRON_IMPORT_UPDATED_DATE) ?: false;
    }
